...
public interface SynchronizeStrategy {
	SynchronizeStrategy NULL_OBJECT = new SynchronizeStrategy() {
	...
	void synchronizeSynchronously(Runnable afterCompletionAction);

	void synchronizeIfScheduledTimeHasElapsed();

	void synchronizeIfEnabled(SyncOption pushOnChange);
}
